...
import cv2
#main.py -f tiny_image -c nearest_neighbor
...
def svm_classify(train_image_feats, train_labels, test_image_feats):
    ...
    #svc = LinearSVC(penalty='l2', loss='squared_hinge', dual=True, tol=0.0001,
     ...
     #intercept_scaling=1, class_weight=None, verbose=0, random_state=None, max_iter=2000)
    #svc=SVC( C=2.0, kernel='poly', degree=2, gamma='scale', coef0=0.0, 
    #shrinking=True, probability=False, tol=0.001, cache_size=200, class_weight=None,
   #  verbose=False, max_iter=- 1, decision_function_shape='ovr', break_ties=False, random_state=None)
    svc = LinearSVC(penalty='l2', loss='squared_hinge', dual=True, tol=0.0001,
    C=1.0, multi_class='ovr', fit_intercept=True, intercept_scaling=1, class_weight=None, verbose=0, random_state=None, max_iter=1000)
